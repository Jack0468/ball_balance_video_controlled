...
if __name__ == "__main__":
    ...
    DATASET_1_PATH = "./images_iphone/labels_normalized.csv"    # The CSV WITH frame_timestamp_ms
    DATASET_2_PATH = "./session_20260728_102908./labels_normalized.csv"    # The CSV WITHOUT frame_timestamp_ms
    OUTPUT_PATH = "./cropped_yolo/labels_normalized.csv" # The name of your new combined file
