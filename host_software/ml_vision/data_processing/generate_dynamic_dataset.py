...
def main():
    ...
    telemetry_path = os.path.abspath(
        os.path.join(script_dir, "data/02_silver/labels.csv")
    )

    output_dir = os.path.abspath(
        os.path.join(script_dir, "data/06_dynamic_warped_dataset")
    )
    ...
    pose_model_path = os.path.abspath(
        os.path.join(script_dir, "models/yolov8_platform_pose_v2/weights/best.pt")
    )
    ...
    yaml_content = f"""path: /content/ball_balance_video_controlled/host_software/data/06_dynamic_warped_dataset
train: images
val: images
