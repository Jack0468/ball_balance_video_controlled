...
def generate_ground_truth_crops():
    ...
    datasets = [
        {
            "features_csv": os.path.join(data_base, "02_silver", "session_20260728_102908", "yolo_features.csv"),
            "input_images": os.path.join(data_base, "02_silver", "session_20260728_102908", "images"),
            "output_dir": os.path.join(data_base, "02_silver", "session_20260728_102908", "cropped")
        },
        {
            "features_csv": os.path.join(data_base, "03_gold", "images_iphone", "yolo_features.csv"),
            "input_images": os.path.join(data_base, "02_silver", "images_iphone", "images"),
