...
def main():
    parser = argparse.ArgumentParser(
        description="Interactive script to find the exact frame and timestamp."
    )
    ...
    while True:
        ...
        cv2.putText(
            display_frame,
            f"Frame Index: {current_frame}",
            (20, display_frame.shape[0] - 150),
    ...
    print(
        "Please use this frame index and the visible green timestamp in sync_data.py!"
    )
