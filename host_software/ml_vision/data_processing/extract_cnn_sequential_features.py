...
def main():
    ...
    parser.add_argument("--session_dir", default="../../data/01_bronze/session_20260730_174916", help="Path to 01_bronze session")
    parser.add_argument("--out_dir", default="../../data/02_silver/session_20260730_174916", help="Directory to save the new dataset")
    parser.add_argument("--cnn_model", default="../models/cnn_2d_tracker_v3/expert_tracker_best.pth", help="Path to best CNN weights")
    ...
    if not (os.path.exists(telemetry_path) and os.path.exists(timestamps_path) and os.path.exists(video_path)):
    ...
    while cap.isOpened():
        ...
        if frame_idx in synced_telemetry:
            ...
            if prev_touch_x is not None:
                dist = ((touch_x - prev_touch_x)**2 + (touch_y - prev_touch_y)**2)**0.5
                ...
                if len(pixel_centers) >= 4:
                    ...
                    if M is not None:
                        ...
                        if x2 > x1 and y2 > y1:
                            ...
                            ball_pt_mm = np.array([[[touch_x_topleft, touch_y_topleft]]], dtype=np.float32)
