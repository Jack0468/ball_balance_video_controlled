...
def crop_platform_from_csv(csv_path, input_base_dir, output_base_dir):
    ...
    for index, row in df.iterrows():
        ...
        try:
            ...
            print(
                f"Warning: Missing or invalid keypoint data for {image_file}. Skipping."
            )
            continue
...
if __name__ == "__main__":
    ...
    CSV_FILE_PATH = (
        "./session_20260728_102908/yolo_features.csv"  # Path to your CSV file
    )
    INPUT_IMAGES_DIR = (
        "./session_20260728_102908/images"  # Folder containing your original images
    )
