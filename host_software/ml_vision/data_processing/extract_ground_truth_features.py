...
def extract_ground_truth_features():
    ...
    datasets = [
        {
            ...
            "silver_csv": os.path.join(
                data_base,
                "02_silver",
                "session_20260728_102908",
                "labels_normalized.csv",
            ),
        },
        {
            "gold_dir": os.path.join(data_base, "03_gold", "images_iphone"),
            "silver_csv": os.path.join(
                data_base, "02_silver", "images_iphone", "labels_normalized.csv"
            ),
        },
    ]
    ...
    for ds in datasets:
                ...
                features.append(
                    {
                        ...
                        "ball_w": ball_w,
                        "ball_h": ball_h,
                        "kpt0_x": platform_kpts[0][0],
                        "kpt0_y": platform_kpts[0][1],
                        "kpt1_x": platform_kpts[1][0],
                        "kpt1_y": platform_kpts[1][1],
                        "kpt2_x": platform_kpts[2][0],
                        "kpt2_y": platform_kpts[2][1],
                        "kpt3_x": platform_kpts[3][0],
                        "kpt3_y": platform_kpts[3][1],
        ...
        if features:
            ...
            print(
                f"No fully labeled frames (platform + ball) found with telemetry in {gold_dir}"
            )
