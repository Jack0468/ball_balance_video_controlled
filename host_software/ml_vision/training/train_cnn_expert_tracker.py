...
def main():
    ...
    save_path = os.path.join(
        project_dir, "cnn_expert_tracker_v1/expert_tracker_best.pth"
    )
    ...
    for epoch in range(start_epoch, num_epochs):
            ...
            for i, (inputs, targets) in enumerate(test_loader):
                ...
                if i == 0:
                    ...
                    for j in range(min(5, outputs.size(0))):
                        ...
                        print(
                            f"  Target: [{t_np[0]:.4f}, {t_np[1]:.4f}] | Pred: [{p_np[0]:.4f}, {p_np[1]:.4f}]"
                        )
        ...
        latest_path = os.path.join(
            project_dir, "cnn_expert_tracker_v1/expert_tracker_latest.pth"
        )
