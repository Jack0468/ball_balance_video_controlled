...
def main():
    parser = argparse.ArgumentParser(
        description="Train YOLOv8 on the auto-generated ball and marker dataset"
    )
    parser.add_argument(
        "--data_dir",
        required=True,
    ...
    parser.add_argument(
        "--save_dir",
        default="../models",
        help="Project directory to save the trained YOLO models",
    )
    parser.add_argument(
        "--resume",
        type=str,
    ...
    if not os.path.exists(dataset_yaml_path):
        print(
            f"ERROR: {dataset_yaml_path} not found. Ensure you are pointing to the synthetic dataset directory."
        )
        return
    ...
    print(
        "Training complete! Model saved in ../models/yolov8_unified_pose_v1/weights/best.pt"
    )
