...
class BallDataset(Dataset):
    ...
    def __init__(self, csv_file, root_dir, transform=None):
        ...
        if transform:
            ...
            raise ValueError(
                "A transform must be provided to BallDataset to avoid mixing train/test augmentations."
            )
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            raise FileNotFoundError(
                f"Image {img_name} not found. Check if the silver dataset is fully extracted."
            )
