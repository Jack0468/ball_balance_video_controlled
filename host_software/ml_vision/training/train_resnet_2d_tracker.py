...
def main():
    ...
    save_path = os.path.join(
        project_dir, f"{args.arch}_2d_tracker_v1/resnet_2d_tracker_best.pth"
    )
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        latest_path = os.path.join(
            project_dir, f"{args.arch}_2d_tracker_v1/resnet_2d_tracker_latest.pth"
        )
    ...
    curve_path = os.path.join(
        project_dir, f"{args.arch}_2d_tracker_v1/training_curve.png"
    )
    ...
    metrics_path = os.path.join(
        project_dir, f"{args.arch}_2d_tracker_v1/training_metrics.json"
    )
