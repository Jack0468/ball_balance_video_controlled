...
def get_augmentations():
    return A.Compose(
        [
            ...
            A.Affine(
                translate_percent=(-0.1, 0.1), scale=(0.8, 1.2), rotate=(-30, 30), p=0.8
            ),
...
if __name__ == "__main__":
    ...
    input_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "../../data/02_silver/base_images")
    )
    output_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "../../data/03_gold/augmented_dataset")
    )
