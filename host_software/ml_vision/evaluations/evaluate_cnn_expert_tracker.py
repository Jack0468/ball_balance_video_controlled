...
def main():
    ...
    parser.add_argument("--model_path", required=True, help="Path to the trained .pth file (e.g. models/cnn_expert_tracker_v1/expert_tracker_best.pth)")
    args = parser.parse_args()

    print(f"Initializing Evaluation Script for Custom CNN Expert Tracker...")
