...
def main():
    parser = argparse.ArgumentParser(description="Evaluate Spatial ResNet Expert Tracker")
    parser.add_argument("--data_dir", default="../../data/02_silver/session_20260728_102908", help="Path to data directory")
    ...
    print(f"Initializing Temporary Evaluation Script for Spatial Expert Tracker ({args.arch})...")
    ...
    model.fc = SpatialSoftmaxResNetHead(in_channels=num_ftrs, height=feature_map_h, width=feature_map_w)
