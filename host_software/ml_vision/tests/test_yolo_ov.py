...
yolo_ov = YOLO(
    "ml_vision/models/yolov8_platform_markers_v2/weights/best_openvino_model/",
    task="pose",
)
yolo_pt = YOLO(
...
print(
    "V2 OpenVINO boxes:",
    res_ov.boxes.cls.cpu().numpy() if res_ov.boxes is not None else None,
)
print(
    "PT OpenVINO boxes:",
    res_pt.boxes.cls.cpu().numpy() if res_pt.boxes is not None else None,
)
