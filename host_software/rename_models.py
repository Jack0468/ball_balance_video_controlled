...
base_dir = "c:/Users/Admin/Documents/Windows_codespace/VRI_2026/host_software"
...
renames = {
    ...
    "models/yolov8_platform_pose_v1": "models/yolov8_platform_pose_v1",

    "models/resnet18_expert_tracker_v1": "models/resnet18_expert_tracker_v1_v1",
    "models/resnet18_expert_tracker_v1_A": "models/resnet18_expert_tracker_v1_v2",
    "models/resnet18_expert_tracker_v1_B": "models/resnet18_expert_tracker_v1_v3",
    "models/resnet18_expert_tracker_v1_C": "models/resnet18_expert_tracker_v1_v4",
    "models/resnet18_expert_tracker_v1_D": "models/resnet18_expert_tracker_v1_v5",
    "models/resnet18_expert_tracker_v1_subset": "models/resnet18_expert_subset_v1",
    "models/resnet50_expert_tracker_v1": "models/resnet50_expert_tracker_v1_v1",
    "models/resnet18_temporal_tracker_v1": "models/resnet18_temporal_tracker_v1",
    
    "models/mlp_corrector_v1": "models/mlp_mlp_corrector_v1_v1",
...
str_replacements = {old.split('/')[-1]: new.split('/')[-1] for old, new in renames.items()}
