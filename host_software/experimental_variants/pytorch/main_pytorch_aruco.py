"""EXPERIMENTAL ENTRY POINT: PyTorch Vision + ArUco. The baseline implementation using native PyTorch for YOLO inference."""
    ...
    try:
        while True:
            ...
            try:
                ...
                payload = (
                    f"{centered_touch_x:.2f},{centered_touch_y:.2f},0.00,0.00\n".encode(
                        "ascii"
                    )
                )
                if ser is not None:
