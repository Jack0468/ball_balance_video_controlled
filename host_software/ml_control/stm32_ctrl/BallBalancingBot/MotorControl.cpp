...
#define STEPS_TO_ORIGIN_A 0 // steps offset from hardstop
#define STEPS_TO_ORIGIN_B 0 // steps offset from hardstop
#define STEPS_TO_ORIGIN_C 0 // steps offset from hardstop
