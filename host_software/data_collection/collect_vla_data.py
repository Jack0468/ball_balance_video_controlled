...
class VLADataCollector:
    ...
    def start_recording(self):
        ...
        self.csv_writer.writerow(["frame_index", "host_timestamp_ms", "mcu_micros", "target_x", "target_y", 
    ...
    def run(self):
        ...
        try:
            while True:
                ...
                if self.is_recording:
                    cv2.putText(display_frame, f"RECORDING (Frame: {self.frame_index})", (20, 40), 
                ...
                if current_tel:
                    ...
                    cv2.putText(display_frame, f"Ball: {touch_x:.1f}, {touch_y:.1f}", (20, 80), 
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
                    cv2.putText(display_frame, f"Tgt: {target_x:.1f}, {target_y:.1f}", (20, 110), 
                                cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 150, 255), 2)
                else:
                    cv2.putText(display_frame, "WAITING FOR STM32 TELEMETRY...", (20, 80), 
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Collect Multimodal VLA demonstrations.')
    parser.add_argument('--port', type=str, default='auto', help='STM32 COM port (e.g. COM8 or auto)')
