...
class IphoneDataLogger:
    ...
    def run(self):
        ...
        print(
            "Starting Visual Sync Display. Point your iPhone at the screen AND the robot."
        )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Collect telemetry and show sync screen."
    )
    parser.add_argument(
        "--port",
        type=str,
        required=True,
        help="STM32 COM port (e.g. COM8 or /dev/ttyACM0)",
    )
