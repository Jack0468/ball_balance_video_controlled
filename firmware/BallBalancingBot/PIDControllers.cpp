...
//Runs X and Y PID Controllers using externally provided coordinates
void pid_balance_with_coords(double setpoint_x, double setpoint_y, double current_x, double current_y) {
  ...
  if (dt >= 0.01) {
    bool detected = true; // Assume true since coordinates are supplied externally by ML vision
    coords p = {current_x, current_y, 0}; // Use the provided coordinates
