...
// Jetson-VLA-angle-control variant (firmware/stm32_jetson_vla_angle_control/)
// -- copied unchanged from stm32_jetson_remote_control/'s TouchProbe.cpp. See
// TouchProbe.h for what differs from the stm32_ml_control_and_vision/
// original and why (no SerialCoords dependency, no vis_x/vis_y echo), and
// AngleStepControl.h for why this firmware directory exists.
//
