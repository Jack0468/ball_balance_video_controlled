...
OK_USBSPEED_SS_GEN1X2 = _ok.OK_USBSPEED_SS_GEN1X2
OK_USBSPEED_SS_GEN2 = _ok.OK_USBSPEED_SS_GEN2
OK_USBSPEED_SS_GEN2X2 = _ok.OK_USBSPEED_SS_GEN2X2
...
okUSBSPEED_SS_GEN1X2 = _ok.okUSBSPEED_SS_GEN1X2
okUSBSPEED_SS_GEN2 = _ok.okUSBSPEED_SS_GEN2
okUSBSPEED_SS_GEN2X2 = _ok.okUSBSPEED_SS_GEN2X2
...
OK_INTERFACE_GEN3 = _ok.OK_INTERFACE_GEN3
...
okDEVICEINTERFACE_GEN3 = _ok.okDEVICEINTERFACE_GEN3
...
OK_PRODUCT_SZGHUB1450AU10P = _ok.OK_PRODUCT_SZGHUB1450AU10P
OK_PRODUCT_SZGHUB1450AU25P = _ok.OK_PRODUCT_SZGHUB1450AU25P
...
okPRODUCT_SZGHUB1450AU10P = _ok.okPRODUCT_SZGHUB1450AU10P
okPRODUCT_SZGHUB1450AU25P = _ok.okPRODUCT_SZGHUB1450AU25P
...
okDEVICESENSOR_POWER = _ok.okDEVICESENSOR_POWER
...
class okTOperationStatistics(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    TransferByteCount = property(_ok.okTOperationStatistics_TransferByteCount_get, _ok.okTOperationStatistics_TransferByteCount_set)
    TransactionCount = property(_ok.okTOperationStatistics_TransactionCount_get, _ok.okTOperationStatistics_TransactionCount_set)

    def __init__(self):
        _ok.okTOperationStatistics_swiginit(self, _ok.new_okTOperationStatistics())
    __swig_destroy__ = _ok.delete_okTOperationStatistics

# Register okTOperationStatistics in _ok:
_ok.okTOperationStatistics_swigregister(okTOperationStatistics)
...
ErrorCode_NoError = _ok.ErrorCode_NoError
ErrorCode_Failed = _ok.ErrorCode_Failed
ErrorCode_Timeout = _ok.ErrorCode_Timeout
ErrorCode_DoneNotHigh = _ok.ErrorCode_DoneNotHigh
ErrorCode_TransferError = _ok.ErrorCode_TransferError
ErrorCode_CommunicationError = _ok.ErrorCode_CommunicationError
ErrorCode_InvalidBitstream = _ok.ErrorCode_InvalidBitstream
ErrorCode_FileError = _ok.ErrorCode_FileError
ErrorCode_DeviceNotOpen = _ok.ErrorCode_DeviceNotOpen
ErrorCode_InvalidEndpoint = _ok.ErrorCode_InvalidEndpoint
ErrorCode_InvalidBlockSize = _ok.ErrorCode_InvalidBlockSize
ErrorCode_I2CRestrictedAddress = _ok.ErrorCode_I2CRestrictedAddress
ErrorCode_I2CBitError = _ok.ErrorCode_I2CBitError
ErrorCode_I2CNack = _ok.ErrorCode_I2CNack
ErrorCode_I2CUnknownStatus = _ok.ErrorCode_I2CUnknownStatus
ErrorCode_UnsupportedFeature = _ok.ErrorCode_UnsupportedFeature
ErrorCode_FIFOUnderflow = _ok.ErrorCode_FIFOUnderflow
ErrorCode_FIFOOverflow = _ok.ErrorCode_FIFOOverflow
ErrorCode_DataAlignmentError = _ok.ErrorCode_DataAlignmentError
ErrorCode_InvalidResetProfile = _ok.ErrorCode_InvalidResetProfile
ErrorCode_InvalidParameter = _ok.ErrorCode_InvalidParameter
ErrorCode_AXISlaveError = _ok.ErrorCode_AXISlaveError
ErrorCode_AXIDecodeError = _ok.ErrorCode_AXIDecodeError
ErrorCode_GatewareTimeout = _ok.ErrorCode_GatewareTimeout
ErrorCode_EntitlementFailed = _ok.ErrorCode_EntitlementFailed
ErrorCode_FrontPanelNotEnabled = _ok.ErrorCode_FrontPanelNotEnabled
class okCFrontPanelAXILite(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    ...
    def Reset(self) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanelAXILite_Reset(self)

    def Read(self, *args) -> "UINT32":
        return _ok.okCFrontPanelAXILite_Read(self, *args)

    def Write(self, *args) -> "void":
        return _ok.okCFrontPanelAXILite_Write(self, *args)

    def ReadBulk(self, *args) -> "UINT64":
        return _ok.okCFrontPanelAXILite_ReadBulk(self, *args)

    def WriteBulk(self, *args) -> "okTOperationStatistics":
        return _ok.okCFrontPanelAXILite_WriteBulk(self, *args)
    __swig_destroy__ = _ok.delete_okCFrontPanelAXILite

# Register okCFrontPanelAXILite in _ok:
_ok.okCFrontPanelAXILite_swigregister(okCFrontPanelAXILite)

class okCFrontPanelAXIFull(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    ...
    def GetDatapathWidthByteCount(self) -> "UINT8":
        return _ok.okCFrontPanelAXIFull_GetDatapathWidthByteCount(self)

    def Reset(self) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanelAXIFull_Reset(self)

    def Read(self, *args) -> "UINT64":
        return _ok.okCFrontPanelAXIFull_Read(self, *args)

    def Write(self, *args) -> "okTOperationStatistics":
        return _ok.okCFrontPanelAXIFull_Write(self, *args)
    __swig_destroy__ = _ok.delete_okCFrontPanelAXIFull

# Register okCFrontPanelAXIFull in _ok:
_ok.okCFrontPanelAXIFull_swigregister(okCFrontPanelAXIFull)

class okCFrontPanelAXIStream(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    ...
    def GetWriteDatapathWidthByteCount(self) -> "UINT8":
        return _ok.okCFrontPanelAXIStream_GetWriteDatapathWidthByteCount(self)

    def GetReadDatapathWidthByteCount(self) -> "UINT8":
        return _ok.okCFrontPanelAXIStream_GetReadDatapathWidthByteCount(self)

    def Reset(self) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanelAXIStream_Reset(self)

    def Read(self, *args) -> "UINT64":
        return _ok.okCFrontPanelAXIStream_Read(self, *args)

    def Write(self, *args) -> "UINT64":
        return _ok.okCFrontPanelAXIStream_Write(self, *args)
    __swig_destroy__ = _ok.delete_okCFrontPanelAXIStream

# Register okCFrontPanelAXIStream in _ok:
_ok.okCFrontPanelAXIStream_swigregister(okCFrontPanelAXIStream)

class okCFPGADataPortAXI(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, *args):
        _ok.okCFPGADataPortAXI_swiginit(self, _ok.new_okCFPGADataPortAXI(*args))

    def GetAXILite(self) -> "OpalKellyLegacy::okCFrontPanelAXILite":
        return _ok.okCFPGADataPortAXI_GetAXILite(self)

    def GetAXIFull(self) -> "OpalKellyLegacy::okCFrontPanelAXIFull":
        return _ok.okCFPGADataPortAXI_GetAXIFull(self)

    def GetAXIStream(self) -> "OpalKellyLegacy::okCFrontPanelAXIStream":
        return _ok.okCFPGADataPortAXI_GetAXIStream(self)
    __swig_destroy__ = _ok.delete_okCFPGADataPortAXI

# Register okCFPGADataPortAXI in _ok:
_ok.okCFPGADataPortAXI_swigregister(okCFPGADataPortAXI)

class okCFPGADataPortClassic(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, *args):
        _ok.okCFPGADataPortClassic_swiginit(self, _ok.new_okCFPGADataPortClassic(*args))

    def ResetFPGA(self) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_ResetFPGA(self)

    def SetWireInValue(self, *args) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_SetWireInValue(self, *args)

    def GetWireInValue(self, epAddr: 'int') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_GetWireInValue(self, epAddr)

    def UpdateWireIns(self) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_UpdateWireIns(self)

    def GetWireOutValue(self, epAddr: 'int') -> "unsigned long":
        return _ok.okCFPGADataPortClassic_GetWireOutValue(self, epAddr)

    def UpdateWireOuts(self) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_UpdateWireOuts(self)

    def ActivateTriggerIn(self, epAddr: 'int', bit: 'int') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_ActivateTriggerIn(self, epAddr, bit)

    def UpdateTriggerOuts(self) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_UpdateTriggerOuts(self)

    def IsTriggered(self, epAddr: 'int', mask: 'UINT32') -> "bool":
        return _ok.okCFPGADataPortClassic_IsTriggered(self, epAddr, mask)

    def GetTriggerOutVector(self, epAddr: 'int') -> "UINT32":
        return _ok.okCFPGADataPortClassic_GetTriggerOutVector(self, epAddr)

    def SetBTPipePollingInterval(self, interval: 'int') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_SetBTPipePollingInterval(self, interval)

    def ReadRegisters(self, regs: 'okTRegisterEntries') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_ReadRegisters(self, regs)

    def WriteRegister(self, addr: 'UINT32', data: 'UINT32') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_WriteRegister(self, addr, data)

    def WriteRegisters(self, regs: 'okTRegisterEntries') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFPGADataPortClassic_WriteRegisters(self, regs)

    def ReadRegister(self, addr: 'UINT32') -> "UINT32":
        return _ok.okCFPGADataPortClassic_ReadRegister(self, addr)

    def WriteToPipeIn(self, epAddr: 'int', data: 'char *') -> "long":
        return _ok.okCFPGADataPortClassic_WriteToPipeIn(self, epAddr, data)

    def ReadFromPipeOut(self, epAddr: 'int', data: 'char *') -> "long":
        return _ok.okCFPGADataPortClassic_ReadFromPipeOut(self, epAddr, data)

    def WriteToBlockPipeIn(self, epAddr: 'int', blockSize: 'int', data: 'char *') -> "long":
        return _ok.okCFPGADataPortClassic_WriteToBlockPipeIn(self, epAddr, blockSize, data)

    def ReadFromBlockPipeOut(self, epAddr: 'int', blockSize: 'int', data: 'char *') -> "long":
        return _ok.okCFPGADataPortClassic_ReadFromBlockPipeOut(self, epAddr, blockSize, data)

    def WriteToPipeInThr(self, epAddr: 'int', data: 'char *') -> "long":
        return _ok.okCFPGADataPortClassic_WriteToPipeInThr(self, epAddr, data)

    def ReadFromPipeOutThr(self, epAddr: 'int', data: 'char *') -> "long":
        return _ok.okCFPGADataPortClassic_ReadFromPipeOutThr(self, epAddr, data)

    def WriteToBlockPipeInThr(self, epAddr: 'int', blockSize: 'int', data: 'char *') -> "long":
        return _ok.okCFPGADataPortClassic_WriteToBlockPipeInThr(self, epAddr, blockSize, data)

    def ReadFromBlockPipeOutThr(self, epAddr: 'int', blockSize: 'int', data: 'char *') -> "long":
        return _ok.okCFPGADataPortClassic_ReadFromBlockPipeOutThr(self, epAddr, blockSize, data)
    __swig_destroy__ = _ok.delete_okCFPGADataPortClassic

# Register okCFPGADataPortClassic in _ok:
_ok.okCFPGADataPortClassic_swigregister(okCFPGADataPortClassic)
...
class okCFrontPanel(object):
    ...
    @staticmethod
    def GetErrorMessage(ec: 'OpalKellyLegacy::ErrorCode') -> "char const *":
        return _ok.okCFrontPanel_GetErrorMessage(ec)

    def GetLastError(self) -> "OpalKellyLegacy::ErrorCode":
    ...
    @staticmethod
    def AddCustomDevice(matchInfo: 'okTDeviceMatchInfo', devInfo: 'okTDeviceInfo'=None) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_AddCustomDevice(matchInfo, devInfo)

    @staticmethod
    def RemoveCustomDevice(productID: 'int') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_RemoveCustomDevice(productID)

    def GetFPGAResetProfile(self, method: 'okEFPGAConfigurationMethod', profile: 'okTFPGAResetProfile') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_GetFPGAResetProfile(self, method, profile)

    def SetFPGAResetProfile(self, method: 'okEFPGAConfigurationMethod', profile: 'okTFPGAResetProfile') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_SetFPGAResetProfile(self, method, profile)

    def FlashEraseSector(self, address: 'UINT32') -> "OpalKellyLegacy::ErrorCode":
    ...
    def GetDeviceInfo(self, info: 'okTDeviceInfo') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_GetDeviceInfo(self, info)

    def GetDeviceSettings(self, settings: 'okCDeviceSettings') -> "OpalKellyLegacy::ErrorCode":
    ...
    def ClearFPGAConfiguration(self) -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_ClearFPGAConfiguration(self)

    def ConfigureFPGA(self, strFilename: 'std::string const &') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_ConfigureFPGA(self, strFilename)

    def ConfigureFPGAFromFlash(self, configIndex: 'unsigned long') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_ConfigureFPGAFromFlash(self, configIndex)

    def GetPLL22150Configuration(self, pll: 'okCPLL22150') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_GetPLL22150Configuration(self, pll)

    def SetPLL22150Configuration(self, pll: 'okCPLL22150') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_SetPLL22150Configuration(self, pll)

    def GetEepromPLL22150Configuration(self, pll: 'okCPLL22150') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_GetEepromPLL22150Configuration(self, pll)

    def SetEepromPLL22150Configuration(self, pll: 'okCPLL22150') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_SetEepromPLL22150Configuration(self, pll)

    def GetPLL22393Configuration(self, pll: 'okCPLL22393') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_GetPLL22393Configuration(self, pll)

    def SetPLL22393Configuration(self, pll: 'okCPLL22393') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_SetPLL22393Configuration(self, pll)

    def GetEepromPLL22393Configuration(self, pll: 'okCPLL22393') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_GetEepromPLL22393Configuration(self, pll)

    def SetEepromPLL22393Configuration(self, pll: 'okCPLL22393') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_SetEepromPLL22393Configuration(self, pll)

    def LoadDefaultPLLConfiguration(self) -> "OpalKellyLegacy::ErrorCode":
    ...
    def FlashWrite(self, address: 'UINT32', data: 'char *') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_FlashWrite(self, address, data)

    def FlashRead(self, address: 'UINT32', data: 'char *') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_FlashRead(self, address, data)

    def ReadI2C(self, addr: 'int', data: 'char *') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_ReadI2C(self, addr, data)

    def WriteI2C(self, addr: 'int', data: 'char *') -> "OpalKellyLegacy::ErrorCode":
        return _ok.okCFrontPanel_WriteI2C(self, addr, data)

    def ConfigureFPGAFromMemory(self, data: 'unsigned char *') -> "OpalKellyLegacy::ErrorCode":
    ...
    def GetFPGADataPortAXI(self) -> "OpalKellyLegacy::okCFPGADataPortAXI":
        return _ok.okCFrontPanel_GetFPGADataPortAXI(self)

    def GetFPGADataPortClassic(self) -> "OpalKellyLegacy::okCFPGADataPortClassic":
        return _ok.okCFrontPanel_GetFPGADataPortClassic(self)
...
def okCFrontPanel_GetErrorMessage(ec: 'OpalKellyLegacy::ErrorCode') -> "char const *":
    return _ok.okCFrontPanel_GetErrorMessage(ec)

def okCFrontPanel_AddCustomDevice(matchInfo: 'okTDeviceMatchInfo', devInfo: 'okTDeviceInfo'=None) -> "OpalKellyLegacy::ErrorCode":
    return _ok.okCFrontPanel_AddCustomDevice(matchInfo, devInfo)

def okCFrontPanel_RemoveCustomDevice(productID: 'int') -> "OpalKellyLegacy::ErrorCode":
    return _ok.okCFrontPanel_RemoveCustomDevice(productID)
...
def FrontPanelEmulateTestDeviceConnection(serial: 'std::string const &', connect: 'bool') -> "OpalKelly::ErrorCode":
...
_ec_members = {
    name[len("ErrorCode_"):]: value
    for name, value in list(globals().items())
    if name.startswith("ErrorCode_") and isinstance(value, int)
}
ErrorCode = _enum.IntEnum("ErrorCode", _ec_members)
assert len(ErrorCode), "ErrorCode IntEnum is empty -- SWIG naming convention may have changed"

for _name in _ec_members:
    del globals()[f"ErrorCode_{_name}"]
del _ec_members, _name, _enum
