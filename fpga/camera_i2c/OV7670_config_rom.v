...
module OV7670_config_rom(
    ...
    13: dout <= 16'h50_B3; //MTX2       RGB565
    14: dout <= 16'h51_00; //MTX3       RGB565
    15: dout <= 16'h52_3D; //MTX4       RGB565
    16: dout <= 16'h53_A7; //MTX5       RGB565
    ...
    24: dout <= 16'h19_02; //VSTART     standard VGA
    25: dout <= 16'h1A_7A; //VSTOP      standard VGA
    26: dout <= 16'h03_0A; //VREF       standard VGA
    27: dout <= 16'h0F_41; //COM6       reset timings
    28: dout <= 16'h1E_00; //MVFP       disable mirror / flip //might have magic value of 03
    29: dout <= 16'h33_0B; //CHLF       //magic value from the internet
    30: dout <= 16'h3C_78; //COM12      no HREF when VSYNC low
    31: dout <= 16'h69_00; //GFIX       fix gain control
    32: dout <= 16'h74_00; //REG74      Digital gain control
    33: dout <= 16'hB0_84; //RSVD       magic value from the internet *required* for good color
    34: dout <= 16'hB1_0c; //ABLC1
    35: dout <= 16'hB2_0e; //RSVD       more magic internet values
    36: dout <= 16'hB3_80; //THL_ST
    ...
    57: dout <= 16'h89_e8;
    //AGC and AEC
    58: dout <= 16'h13_e0; //COM8, disable AGC / AEC
    59: dout <= 16'h00_00; //set gain reg to 0 for AGC
    60: dout <= 16'h10_00; //set ARCJ reg to 0
    61: dout <= 16'h0d_40; //magic reserved bit for COM4
    62: dout <= 16'h14_18; //COM9, 4x gain + magic bit
    63: dout <= 16'ha5_05; // BD50MAX
    64: dout <= 16'hab_07; //DB60MAX
    65: dout <= 16'h24_95; //AGC upper limit
    66: dout <= 16'h25_33; //AGC lower limit
    67: dout <= 16'h26_e3; //AGC/AEC fast mode op region
    68: dout <= 16'h9f_78; //HAECC1
    69: dout <= 16'ha0_68; //HAECC2
    70: dout <= 16'ha1_03; //magic
    71: dout <= 16'ha6_d8; //HAECC3
    72: dout <= 16'ha7_d8; //HAECC4
    73: dout <= 16'ha8_f0; //HAECC5
